...
st.sidebar.expander("Debug Info").write({
    ...
    "Models directory contents": os.listdir("models") if os.path.exists("models") else "Not found",
...
def load_dataset(data_path):
    try:
        ...
        # Create a simple dummy dataset if the real one can't be loaded
        return pd.DataFrame({"fetal_health": [1, 2, 3]})
